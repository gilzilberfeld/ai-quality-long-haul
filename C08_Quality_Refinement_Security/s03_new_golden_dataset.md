...
4.  **Edge Cases:**
    * **Test Case 1: **Test Case 1: Very small User ID:** Request a user with the lowest possible valid ID (e.g., 1)
...
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------|------------------------------|------------------------------|---------------------------------|-------------|-------------|
| GET /users/{id} | **Explanation**: Correct.<br>**Happy Path**: Mid.<br>**Unhappy Path**: Good.<br>**Edge Cases**: Mid.<br>**Security Cases**: Incorrect | 3                            | 3                            | 2                               | 1           | 9/12        |